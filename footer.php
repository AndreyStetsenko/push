            ...
            <div class="row">
                <div class="col-1">
                    <div class="formfooter__title">
                        <span class="formfooter__title-first">Push-старт</span>
                        <span class="formfooter__title-second">для твого бренду</span>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-1">
                    <div class="footer__nav">
                        ...
                        <div class="menu">
                            <ul>
                                <li><a href="https://t.me/pushagency">
                                    <div class="icon">
                                    ...
                                    <span>tg: @pushagency</span>
                                </a></li>
                                <li><a href="mailto:hello@pushagency.com">
                                    <div class="icon">
                                        <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span>hello@pushagency.com</span>
                                </a></li>
                                <li><a href="tel:+380675552341">
                                    <div class="icon">
                                        <svg viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
